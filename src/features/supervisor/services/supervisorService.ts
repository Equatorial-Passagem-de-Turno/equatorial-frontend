...
const mapOccurrence = (
  ...
  return {
    ...
    geographicBase: String(location.zone || location.city || location.sector || 'N/A'),
    feeder: String(location.feeder || 'N/A'),
    substation: String(location.substation || location.city || 'N/A'),
    serviceOrder: undefined,
    location: {
      sector: location.sector ? String(location.sector) : undefined,
      city: String(location.city || 'N/A'),
      district: String(location.district || location.neighborhood || 'N/A'),
